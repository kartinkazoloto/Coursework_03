    ...
    def __init__(self, db_manger: DBManager):
        ...
        self.menu_items = {
            "1": ("Получение списка всех компаний и количество вакансий у каждой компании",
                  self.get_01),
            "2": ("Получение списка всех вакансий, с указанием названия компании, названия вакансии, "
                  "зарплаты и ссылки на вакансию", self.get_02),
            ...
            "4": ("Получение списка всех вакансий, у которых зарплата выше средней по всем вакансиям",
                  self.get_04),
            "5": ("Получение списка всех вакансий, в названии которы содержатся переданные в метод слова",
                  self.get_05),
